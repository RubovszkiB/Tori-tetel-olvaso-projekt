...
public partial class PersonQuizPage : ContentPage
{
    ...
    private List<PersonQuestion> _questions = new();
    private int _currentIndex = 0;
    private int _score = 0;

    public PersonQuizPage(int tetelNumber, string tetelTitle)
    {
        InitializeComponent();
    ...
    {
        _questions = _personQuizService.GetQuestionsForTetel(_tetelNumber);
        _currentIndex = 0;
        _score = 0;
